    ...
    <>
      <div className="flex bg-purple-900 w-full p-3 rounded-[10px] text-white my-4 shadow-md relative">
        <div className="relative z-10">
          <h1 className="mb-4 font-semibold text-2xl">Hello, {name}!</h1>
          <p className="xl:w-[60%] lg:w-[44rem] text-[16px] text-justify xl:mb-5">
        ...
        <div className="hidden xl:block absolute z-0 top-[-0.4rem] right-[0rem] xl:h-[11.5rem] min-w-fit">
          <img
